...
void  funcion_hebra_productora(  )
{
   for( unsigned i = 0 ; i < num_items ; i++ )
   {
      ...
      // No es necesaria la exclusión mutua en FIFO con el consumidor
      buffer[primera_libre] = dato; // Guarda el dato
...
void funcion_hebra_consumidora(  )
{
   for( unsigned i = 0 ; i < num_items ; i++ )
   {
      ...
      // No es necesaria la exclusión mutua en FIFO con el productor
