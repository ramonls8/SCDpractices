...
/*
make filosofos_mpi_exe; mpirun -oversubscribe -np 10 filosofos_mpi_exe
*/
// -----------------------------------------------------------------------------
//
...
void funcion_filosofos( int id )
{
   ...
   while ( true ){
      // Si uno de los filósofos coge primero el tenedor de su izquierda,
      // no se puede llegar a la situación de interbloqueo
      if (id == 0){
