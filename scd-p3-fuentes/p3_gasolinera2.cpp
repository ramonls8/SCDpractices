...
/*
make p3_gasolinera2_mpi_exe; mpirun -oversubscribe -np 11 p3_gasolinera2_mpi_exe
*/
...
void repostar(int num_coche, int tipo){
    ...
    cout << "Coche " << num_coche << " de tipo " << tipo << " empieza a repostar" << endl;

    this_thread::sleep_for(duration);

    cout << "Coche " << num_coche << " de tipo " << tipo << " termina de repostar" << endl;
}
//-------------------------------------------------------------------------------
void esperar(int num_coche, int tipo){
    milliseconds duration(aleatorio<20,100>());

    cout << "Coche " << num_coche << " de tipo " << tipo << " espera fuera" << endl;

    this_thread::sleep_for(duration);

    cout << "Coche " << num_coche << " de tipo " << tipo << " termina de esperar" << endl;
}
...
void funcion_coche(int id){
   ...
   while(true){
      cout << "Coche "<<id<<" de tipo "<<tipo<<" quiere entrar a respostar"<<endl;
